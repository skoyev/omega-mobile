...
{
    return [self.product.forks count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *fork = [self.product.forks objectAtIndex:[indexPath row]];
...
{
    UIView *header = [[UIView alloc] initWithFrame:CGRectMake(140, 0, tableView.frame.size.width, 60.0)];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    self.product.fork = [self.product.forks objectAtIndex:[indexPath row]];
