...
# Purpose
Omega Sales App assists car dealers which represented in Canada, USA, and Internationally
to request a quote directly on their mobile phones. The App determine which product
...
# Platform
The Sales App is written in native iOS8/Objective-C and Android SDK to ensure the best user experience and
overcome any limitations in pre-built cross platforms as well as with HTML5. This also ensure
...
portal is developed to support secured mobile users authentication. An access panel is created which allows authorized staff
...
# Back
The back button allow users to go one step back if they are in the product selector. This allows navigation within the product selector logic sequence.
...
directly from this page. An option can send a PDF attachment of product series.